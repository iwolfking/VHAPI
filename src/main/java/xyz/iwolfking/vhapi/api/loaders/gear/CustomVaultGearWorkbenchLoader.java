...
public class CustomVaultGearWorkbenchLoader extends VaultConfigProcessor<VaultGearWorkbenchConfig> {

    public Map<Item, VaultGearWorkbenchConfig> WORKBENCH_CONFIGS = new HashMap<>();

    public CustomVaultGearWorkbenchLoader() {
        super(new VaultGearWorkbenchConfig(ModItems.SWORD), "gear/gear_workbench");
    }
