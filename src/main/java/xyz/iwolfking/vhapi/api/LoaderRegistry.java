...
public class LoaderRegistry {
    ...
    public static void initProcessors() {
        ...
        addConfigProcessor(Processors.RecipesConfigProcessors.OVERWORLD_INSCRIPTION_RECIPES_LOADER);
        ...
        addConfigProcessor(Processors.VaultGearConfigProcessors.UNIQUE_DISCOVERY_CONFIG_LOADER);
