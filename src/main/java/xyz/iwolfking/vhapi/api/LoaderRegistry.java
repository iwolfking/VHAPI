...
import xyz.iwolfking.vhapi.api.lib.config.loaders.bounty.BountyRewardsConfigLoader;
import xyz.iwolfking.vhapi.api.lib.config.loaders.box.MappedWeightedProductEntryConfigLoader;
import xyz.iwolfking.vhapi.api.lib.config.loaders.box.WeightedProductEntryConfigLoader;
import xyz.iwolfking.vhapi.api.lib.config.loaders.card.*;
import xyz.iwolfking.vhapi.api.lib.config.loaders.expertises.ExpertiseConfigLoader;
import xyz.iwolfking.vhapi.api.lib.config.loaders.expertises.ExpertisesGUIConfigLoader;
import xyz.iwolfking.vhapi.api.lib.config.loaders.gear.GearEnchantmentConfigLoader;
import xyz.iwolfking.vhapi.api.lib.config.loaders.gear.TrinketConfigLoader;
import xyz.iwolfking.vhapi.api.lib.config.loaders.gear.transmog.CustomGearModelRollRaritiesConfigLoader;
import xyz.iwolfking.vhapi.api.lib.config.loaders.gear.transmog.GearModelRollRaritiesConfigLoader;
import xyz.iwolfking.vhapi.api.lib.config.loaders.gear.transmog.HandheldModelRegistryConfigLoader;
import xyz.iwolfking.vhapi.api.lib.config.loaders.gear.transmog.ShieldModelRegistryConfigLoader;
import xyz.iwolfking.vhapi.api.lib.config.loaders.gen.loot_table.LootTableConfigLoader;
import xyz.iwolfking.vhapi.api.lib.config.loaders.gen.palettes.PalettesConfigLoader;
import xyz.iwolfking.vhapi.api.lib.config.loaders.gen.template_pools.TemplatePoolsConfigLoader;
import xyz.iwolfking.vhapi.api.lib.config.loaders.gen.theme.ThemeConfigLoader;
import xyz.iwolfking.vhapi.api.lib.config.loaders.general.TooltipConfigLoader;
import xyz.iwolfking.vhapi.api.lib.config.loaders.general.VaultStatsConfigLoader;
import xyz.iwolfking.vhapi.api.lib.config.loaders.items.AugmentConfigLoader;
import xyz.iwolfking.vhapi.api.lib.config.loaders.items.InscriptionConfigLoader;
import xyz.iwolfking.vhapi.api.lib.config.loaders.loot.LegacyLootTableConfigLoader;
import xyz.iwolfking.vhapi.api.lib.config.loaders.loot.LootInfoConfigLoader;
import xyz.iwolfking.vhapi.api.lib.config.loaders.misc.ChampionsConfigLoader;
import xyz.iwolfking.vhapi.api.lib.config.loaders.misc.CustomEntitySpawnersLoader;
import xyz.iwolfking.vhapi.api.lib.config.loaders.misc.EntityGroupsConfigLoader;
import xyz.iwolfking.vhapi.api.lib.config.loaders.recipes.*;
import xyz.iwolfking.vhapi.api.lib.config.loaders.research.ResearchConfigLoader;
import xyz.iwolfking.vhapi.api.lib.config.loaders.research.ResearchGUIConfigLoader;
import xyz.iwolfking.vhapi.api.lib.config.loaders.research.groups.ResearchGroupConfigLoader;
import xyz.iwolfking.vhapi.api.lib.config.loaders.research.groups.ResearchGroupGUIConfigLoader;
import xyz.iwolfking.vhapi.api.lib.config.loaders.shops.NormalBlackMarketConfigLoader;
import xyz.iwolfking.vhapi.api.lib.config.loaders.shops.OmegaBlackMarketConfigLoader;
import xyz.iwolfking.vhapi.api.lib.config.loaders.shops.ShoppingPedestalConfigLoader;
import xyz.iwolfking.vhapi.api.lib.config.loaders.skills.AbilitiesConfigLoader;
import xyz.iwolfking.vhapi.api.lib.config.loaders.skills.AbilitiesGUIConfigLoader;
import xyz.iwolfking.vhapi.api.lib.config.loaders.skills.descriptions.AbilitiesDescriptionsConfigLoader;
import xyz.iwolfking.vhapi.api.lib.config.loaders.skills.descriptions.SkillDescriptionsConfigLoader;
import xyz.iwolfking.vhapi.api.lib.config.loaders.skills.gates.SkillGatesConfigLoader;
import xyz.iwolfking.vhapi.api.lib.config.loaders.talents.TalentConfigLoader;
import xyz.iwolfking.vhapi.api.lib.config.loaders.talents.TalentsGUIConfigLoader;
import xyz.iwolfking.vhapi.api.lib.config.loaders.titles.CustomTitleConfigLoader;
import xyz.iwolfking.vhapi.api.lib.config.loaders.tool.PulverizingConfigLoader;
import xyz.iwolfking.vhapi.api.lib.config.loaders.vault.altar.VaultAltarConfigLoader;
import xyz.iwolfking.vhapi.api.lib.config.loaders.vault.catalyst.CatalystConfigLoader;
import xyz.iwolfking.vhapi.api.lib.config.loaders.vault.chest.VaultChestMetaConfigLoader;
import xyz.iwolfking.vhapi.api.lib.config.loaders.vault.crystal.VaultCrystalCatalystModifiersConfigLoader;
import xyz.iwolfking.vhapi.api.lib.config.loaders.vault.crystal.VaultCrystalConfigLoader;
import xyz.iwolfking.vhapi.api.lib.config.loaders.gear.CustomVaultGearLoader;
import xyz.iwolfking.vhapi.api.lib.config.loaders.gear.CustomVaultGearWorkbenchLoader;
import xyz.iwolfking.vhapi.api.lib.config.loaders.objectives.BingoConfigLoader;
import xyz.iwolfking.vhapi.api.lib.config.loaders.objectives.ElixirConfigLoader;
import xyz.iwolfking.vhapi.api.lib.config.loaders.objectives.MonolithConfigLoader;
import xyz.iwolfking.vhapi.api.lib.config.loaders.objectives.ScavengerConfigLoader;
import xyz.iwolfking.vhapi.api.lib.config.loaders.vault.general.VaultGeneralConfigLoader;
import xyz.iwolfking.vhapi.api.lib.config.loaders.vault.general.VaultLevelsConfigLoader;
import xyz.iwolfking.vhapi.api.lib.config.loaders.vault.mobs.VaultMobsConfigLoader;
import xyz.iwolfking.vhapi.api.lib.config.loaders.vault.modifiers.VaultModifierConfigLoader;
import xyz.iwolfking.vhapi.api.lib.config.loaders.vault.modifiers.VaultModifierPoolsConfigLoader;
import xyz.iwolfking.vhapi.api.lib.config.loaders.vault.portal.VaultPortalBlockConfigLoader;
import xyz.iwolfking.vhapi.api.lib.config.loaders.vaultar.VaultAltarIngredientsConfigLoader;
import xyz.iwolfking.vhapi.api.lib.config.loaders.workstation.VaultDiffuserConfigLoader;
import xyz.iwolfking.vhapi.api.lib.config.loaders.workstation.VaultRecyclerConfigLoader;
import xyz.iwolfking.vhapi.api.lib.loaders.*;
...
//        }
        event.addListener(GEN_PALETTE_LOADER);
        event.addListener(GEN_TEMPLATE_POOL_LOADER);
        event.addListener(GEN_LOOT_TABLE_LOADER);
    ...
    public static void initProcessors() {
        addConfigProcessor(PALETTES_CONFIG_LOADER);
        addConfigProcessor(TEMPLATE_POOLS_CONFIG_LOADER);
        addConfigProcessor(LOOT_TABLE_CONFIG_LOADER);
        addConfigProcessor(AUGMENT_CONFIG_LOADER);
        addConfigProcessor(VAULT_CRYSTAL_CONFIG_LOADER);
        addConfigProcessor(GEN_THEME_LOADER);
        addConfigProcessor(THEME_CONFIG_LOADER);
    }
...
//    //Vault Generation Files
    public static final GenFileDataLoader<TemplatePool> GEN_TEMPLATE_POOL_LOADER = new GenFileDataLoader<>( TemplatePool.class, "vault_configs/gen/template_pools", new HashMap<>(), "vhapi");
    public static final GenFileDataLoaderRF<Theme> GEN_THEME_LOADER = new GenFileDataLoaderRF<>( Theme.class,"gen/themes", "vhapi");
    public static final GenFileDataLoader<Palette> GEN_PALETTE_LOADER = new GenFileDataLoader<>( Palette.class, "vault_configs/gen/palettes", new HashMap<>(), "vhapi");
    public static final GenFileDataLoader<LootTable> GEN_LOOT_TABLE_LOADER = new GenFileDataLoader<>( LootTable.class, "vault_configs/gen/loot_tables", new HashMap<>(), "vhapi");
//
//    //Misc Configs
