...
public class GearModelRollRaritiesConfigLoader extends VaultConfigDataLoader<GearModelRollRaritiesConfig> {

    public GearModelRollRaritiesConfigLoader(String namespace) {
