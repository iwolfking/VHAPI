...
public class VHAPISyncNetwork {
    ...
    public static final SimpleChannel VHAPI_CHANNEL = NetworkRegistry.newSimpleChannel(VHAPI.of("sync_configs"), () -> PROTOCOL_VERSION, version -> true, PROTOCOL_VERSION::equals);
