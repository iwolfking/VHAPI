...
public interface IVHAPISyncProxy {
    ...
    default void init() {
        ...
        VHAPISyncNetwork.VHAPI_CHANNEL.messageBuilder(VHAPISyncTemplates.class, 1, NetworkDirection.PLAY_TO_CLIENT).encoder(VHAPISyncTemplates.ENCODER).decoder(VHAPISyncTemplates.DECODER).consumer(VHAPISyncTemplates.CONSUMER).noResponse().add();
    }
}
