...
public class GenFileDataLoader<T> extends SimpleJsonResourceReloadListener {
    ...
    public GenFileDataLoader(Class<?> instance, String directory, Map<ResourceLocation, T> configMap, String namespace) {
        super(GSON, directory);
        this.directory = directory;
        this.instance = instance;
        this.CUSTOM_CONFIGS = configMap;
        this.namespace = namespace;
        LoaderRegistry.GEN_FILE_LOADERS.put(new ResourceLocation(this.namespace, this.getName()), this);
    }
